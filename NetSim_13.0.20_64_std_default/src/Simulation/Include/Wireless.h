...
#include "PropagationModel.h"
	...
	static PHY_MODULATION getModulationFromStr(char* s){ \
		for (int i = 0; i < Modulation_LAST; i++) if (!_stricmp(s, strPHY_MODULATION[i])) return (PHY_MODULATION)i; return (PHY_MODULATION)0; \
	}
