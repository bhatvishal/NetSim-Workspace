...
#pragma region PDCP_ENTITY
	typedef struct stru_LTENR_PDCPEntity
	{
		...
		bool isAlternativePacket;//for NSA split algo
...
#pragma region RX_BUFFER_OPTIONAL
