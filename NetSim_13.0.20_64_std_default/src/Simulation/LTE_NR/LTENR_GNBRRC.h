...
#pragma region CONNECTION_MANAGEMENT_STATE
	typedef enum enum_LTENR_UE_CMSTATE
	{
		UE_CM_IDLE,
		UE_CM_CONNECTED,
	}LTENR_UE_CMSTATE;
...
#define SINR_REPORT_REMOVE(ls, mem) (LIST_FREE((void**)(ls),(mem)))
	typedef struct stru_LTENR_UERRC
	{
		...
		LTENR_UE_CMSTATE ueCMState;
		NETSIM_ID SelectedCellID;
		NETSIM_ID SelectedCellIF;
		NETSIM_ID SelectedAMFID;
		NETSIM_ID SelectedAMFIF;
		NETSIM_ID SelectedSMFID;
		NETSIM_ID SelectedSMFIF;
		NETSIM_ID pCell;
		...
		NETSIM_ID SNID;
		NETSIM_ID SNIF;
		LTENR_UE_RRCSTATE ueSNRRCState;
		LTENR_UE_CMSTATE ueSNCMState;
		NETSIM_ID SelectedSNAMFID;
		NETSIM_ID SelectedSNAMFIF;
		NETSIM_ID SelectedSNSMFID;
		NETSIM_ID SelectedSNSMFIF;
